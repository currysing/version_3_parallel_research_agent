...
from google.adk.agents import (
    LlmAgent,
    ParallelAgent,
)  # LlmAgent for individual agents, ParallelAgent for orchestration
...
)  # Common research instructions
base_description = load_instructions_file(
...
question_researcher_agent_1 = LlmAgent(
    ...
    model="gemini-2.5-flash",  # AI model - Gemini 2.5 Flash for fast, high-quality responses
